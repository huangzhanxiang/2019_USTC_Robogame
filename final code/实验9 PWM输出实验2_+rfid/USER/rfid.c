...
//0xAABB + 后续字节数6+设备标识2Byte+命令码2BYTE 0x0801 +命令参数（报文）0x31 ,检验字0x38
//0x0801设置射频工作模式，
u8 Get_uid_data[9] = {0xAA,0xBB,0x05,0x00,0x00,0x00,0x01,0x10,0x11};
//0x0110  ISO15693_Inventory(单卡)
//应答数据: 9 BYTE : 1 BYTE DSFID + 8 BYTE UID
//DSFID 数据储存格式 UID:64位唯一标识符，识别标签身份
u8 RFID_READ_data[20]={0xAA,0xBB,0x10,0x00,0x00,0x00,0x05,0x10,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x00};
	...
	//参数: 1 BYTE model + 8 BYTE UID + 1 BYTE 起始块号 + 1 BYTE 块数
//应答数据：读出数据
